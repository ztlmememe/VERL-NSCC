...
exp_name="DAPO-Qwen2.5-0.5B-Instruct_2nodes1A100_$(timestamp)"
...
# The set of sampled trajectories is split into multiple mini-batches with batch_size=ppo_mini_batch_size (train_prompt_mini_bsz) for PPO actor updates. The ppo_mini_batch_size (train_prompt_mini_bsz) is a global size across all workers.
