...
## Job name
#PBS -N dapo_qwen3_4b_4gpus_trainbsz1

## Merge standard output and error from PBS script
#PBS -j oe
#PBS -o /home/users/ntu/guoweia3/scratch/job_logs/create_dapo_qwen3_4b_4gpus_trainbsz1_train_prompt_bsz1_2.log
...
singularity exec --nv --cleanenv --no-home \
  --bind "$BIND_WORK":/workspace,"$BIND_DATA":/root \
  --pwd /workspace "$IMAGE" /bin/bash nscc/run_insidecon_dapo_qwen3_4b_4gpus_trainbsz1.sh
